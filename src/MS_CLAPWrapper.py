...
from .ms_clap.models.utils import read_config_as_args
from .ms_clap.models.clap import CLAP
from importlib_resources import files


removed_weights = ['audio_encoder.base.fc_audioset.weight', 'audio_encoder.base.fc_audioset.bias']
...
class CLAPWrapper():
    ...
    def __init__(self, model_fp, n_class=None, train=False, use_cuda=False):
        ...
        self.config_as_str = files('src.ms_clap.configs').joinpath('config.yml').read_text()
    ...
    def load_clap(self):
        ...
        clap.load_state_dict(model_state_dict, strict=False)  #False
